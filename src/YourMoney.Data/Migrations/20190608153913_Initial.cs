        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MonthlyAccrual = table.Column<int>(nullable: false),
                    AdditionalTerms = table.Column<string>(nullable: true),
                    Bonuses = table.Column<string>(nullable: true),
                    BankId = table.Column<int>(nullable: false),
                    Amount = table.Column<decimal>(nullable: false),
                    Interest = table.Column<decimal>(nullable: false),
                    InterestForOneMonth = table.Column<decimal>(nullable: false),
                    InterestForThreeMonths = table.Column<decimal>(nullable: false),
                    InterestForSixMonths = table.Column<decimal>(nullable: false),
                    InterestForNineMonths = table.Column<decimal>(nullable: false),
                    InterestForTwelveMonths = table.Column<decimal>(nullable: false),
                    InterestForEighteenMonths = table.Column<decimal>(nullable: false),
                    InterestForTwentyFourMonths = table.Column<decimal>(nullable: false),
                    InterestForThirtySixMonths = table.Column<decimal>(nullable: false),
                    InterestForFortyEightMonths = table.Column<decimal>(nullable: false),
                    InterestForSixtyMonths = table.Column<decimal>(nullable: false),
                    EffectiveAnnualInterestRate = table.Column<decimal>(nullable: false),
                    TotalPaid = table.Column<decimal>(nullable: false),
                    InterestAmount = table.Column<decimal>(nullable: false),
                    InterestTax = table.Column<decimal>(nullable: false),
                    NetPaid = table.Column<decimal>(nullable: false),
